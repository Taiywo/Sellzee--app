...
export const Pricing = () => {
    ...
    return (
        <div className='relative pb-64'>
            ...
            <section >
                <div className="w-[998.99px] h-[405px] opacity-40 bg-[#FDEEE7] rounded-[30px] absolute left-[28rem] bottom-[20rem] " />
                <div className="w-[890.92px] h-[386.11px] opacity-30 bg-[#FDEEE7] rounded-[30px] absolute bottom-96 left-[31rem]  " />

                <div className="w-[1200px] h-[405px] bg-[#FDEEE7] rounded-[30px] mt-[50rem] m-auto p-10 flex flex-col relative items-center gap-10 ">
